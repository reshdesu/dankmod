...
class DankHelpers:
    # init method or constructor
    def __init__(self, _connection=None) -> None:
...
def _everythingisfine(_connection=None):
    ...
    wealth_cc = ['money 1000000', 'sims.give_satisfaction_points 75000']
    ...
    traits = ['Antiseptic', 'Business_Savvy', 'Carefree', 'Collector', 'EternalBond', 'Connections',
              ...
              'Memorable', 'MentallyGifted', 'Mentor', 'MorningPerson', 'Muser', 'OneWithNature',
              ...
              'LivingVicariously', 'Webmaster', 'trait_top_notch_toddler', 'trait_happy_toddler', 'IncrediblyFriendly',
              'StovesAndGrillsMaster', 'trait_SicknessImmunity', 'HomeTurf', 'SpiceHound', 'InTheKnow',
              'ChopstickSavvy',
              'trait_hidden_career_critic_thrifty', 'Antiseptic', 'ProfessionalSlacker']
